...
export const PARTS: readonly Part[] = [
  ...
  { name: 'Shoe', from: 28, to: 33, colour: '#7c7cff' },
  { name: 'Ankle', from: 34, to: 35, colour: '#a08bff' },
  { name: 'Shin, lower', from: 36, to: 41, colour: '#ff6bd6' },
  { name: 'Flashlight', from: 42, to: 51, colour: '#ffd166' },
  { name: 'Shin, upper', from: 52, to: 54, colour: '#ff8fdf' },
  { name: 'Knee', from: 55, to: 56, colour: '#ff4f9a' },
  { name: 'Forearm', from: 57, to: 61, colour: '#ffffff' },
  { name: 'Jaw and throat', from: 62, to: 64, colour: '#c9a06b' },
  { name: 'Cap bill', from: 65, to: 67, colour: '#6bd0ff' },
  { name: 'Cap front', from: 68, to: 71, colour: '#8fdcff' },
];
