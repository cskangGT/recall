...
const ko: Record<StringKey, string> = {
  ...
  'rail.add': '추가 (⌘K)',
  'rail.views': '화면',
  'rail.map.tip': '지도 — 모든 기억이 밤하늘처럼 한눈에. 큰 그림과 검색. (G)',
  'rail.browse.tip': '둘러보기 — 카테고리를 하나씩 걸어 들어가고, 아래에서 대화. (T)',
  'rail.sources.tip': '원본 — 들어온 모든 것의 서랍. 목록 또는 폴더로. (S)',
  'rail.ask.tip': '질문 — 저장해둔 전부에게 물어보기, 인용과 함께 답해요. (⌘/)',
  'rail.settings.tip': '설정 — 언어, 자동 정리, 플랜. (,)',
  'rail.add.tip': '추가 — 메모·링크·스크린샷 저장. (⌘K)',
