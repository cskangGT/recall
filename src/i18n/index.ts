...
const en = {
  ...
  'welcome.fillHint.shots': 'Screenshots piling up unsorted? Throw them all in! {product} reads every one, files them, and hands you exactly the one you need the moment you ask',
  'welcome.fillHint.links': 'All those links saved for later? Hand them over! {product} reads them in one go, files them, and finds the right one the moment you ask',
  'welcome.fillHint.notes': 'Notes scattered everywhere? Drop them all in! {product} sorts them out and answers straight from them when you ask',
  'welcome.profile.shots': 'Screenshots',
  'welcome.profile.links': 'Links',
  'welcome.profile.notes': 'Notes',
  'welcome.profile.thoughts': 'Thoughts',
  'welcome.fillHint.thoughts': 'Thoughts piling up only in your head? One page a day is enough! Ask later, and {product} brings that day back',
...
const ko: Record<StringKey, string> = {
  ...
  'welcome.fillHint.shots': '정리 못 한 스크린샷, 잔뜩 쌓였죠? 한 번에 다 던져 주세요! {product}가 전부 읽어서 정리하고, 필요한 순간에 딱 그 한 장을 꺼내 줘요',
  'welcome.fillHint.links': '언젠가 보려고 저장한 링크, 다 넘겨 주세요! {product}가 한 번에 읽어서 정리하고, 물어보면 바로 그 링크를 찾아 줘요',
  'welcome.fillHint.notes': '여기저기 흩어진 메모, 한꺼번에 놓아 주세요! {product}가 싹 정리해 두고, 물어보면 거기서 바로 답해 줘요',
  'welcome.profile.shots': '스크린샷',
  'welcome.profile.links': '링크',
  'welcome.profile.notes': '메모',
  'welcome.profile.thoughts': '머릿속 생각',
  'welcome.fillHint.thoughts': '적어 두지 않은 생각, 머릿속에만 쌓이죠? 하루 한 페이지면 돼요! 나중의 내가 물어보면 {product}가 그날을 꺼내 줘요',
