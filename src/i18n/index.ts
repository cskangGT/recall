...
const en = {
  ...
  'welcome.fillHint.shots': 'Too many screenshots you never sorted? Drop them all at once — {product} reads and files them, and hands back the ones you need',
  'welcome.fillHint.links': 'The links you saved for later? Give them all at once — {product} reads and files them, and brings the right one back when you ask',
  'welcome.fillHint.notes': 'Notes scattered everywhere? Drop them all at once — {product} files them, and answers from them when you ask',
...
const ko: Record<StringKey, string> = {
  ...
  'welcome.fillHint.shots': '정리 못 한 스크린샷, 많이 쌓였죠? 한 번에 놓으면 {product}가 읽어서 정리하고, 필요한 것만 다시 꺼내 줘요',
  'welcome.fillHint.links': '언젠가 보려고 저장한 링크들, 한 번에 넘기면 {product}가 읽어서 정리하고, 물어보면 바로 꺼내 줘요',
  'welcome.fillHint.notes': '여기저기 흩어진 메모, 한 번에 놓으면 {product}가 정리해 두고, 물어볼 때 거기서 답해 줘요',
