...
const en = {
  ...
  'welcome.sourceFiles': 'Screenshots · notes',
  'toast.imagesKept': 'Kept {count} screenshots — reading them now.',
  'toast.pdfNotYet': "PDFs can't be read yet — paste the text in for now.",
...
const ko: Record<StringKey, string> = {
  ...
  'welcome.sourceFiles': '스크린샷 · 메모 파일',
  'toast.imagesKept': '스크린샷 {count}장을 넣었어요.',
  'toast.pdfNotYet': 'PDF는 아직 읽지 못해요 — 지금은 내용을 복사해 붙여 넣어 주세요.',
  'welcome.instagram': 'Instagram Saved',
