...
const en = {
  ...
  'welcome.fillHint.shots': 'Drop a few of those screenshots — {product} reads and files them',
  'welcome.fillHint.links': 'Paste the links you saved — {product} reads and files them',
  'welcome.fillHint.notes': 'Drop those scattered notes — {product} reads and files them',
  'welcome.profileQ': 'What has been piling up?',
  'welcome.profile.shots': 'Screenshots',
  'welcome.profile.links': 'Links',
  'welcome.profile.notes': 'Notes',
  'welcome.profileConfirm': 'Continue',
  ...
  'welcome.emptyAside':
    `Three or four screenshots off your phone are enough — drop them below and ${PRODUCT} reads them and finds each a place. The map builds itself from there.`,
...
const ko: Record<StringKey, string> = {
  ...
  'welcome.fillHint.shots': '쌓여 있던 스크린샷을 몇 장 놓으면 {product}가 읽고 정리해요',
  'welcome.fillHint.links': '저장해 둔 링크를 붙여넣으면 {product}가 읽고 정리해요',
  'welcome.fillHint.notes': '흩어진 메모를 놓으면 {product}가 읽고 정리해요',
  'welcome.profileQ': '어떤 게 쌓여 있나요?',
  'welcome.profile.shots': '스크린샷',
  'welcome.profile.links': '링크',
  'welcome.profile.notes': '메모',
  'welcome.profileConfirm': '확인',
