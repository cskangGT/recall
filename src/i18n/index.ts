...
const en = {
  ...
  'welcome.profileChange': 'change',
  'welcome.profileAnswered': 'Piling up: {kind}',
  'welcome.profile.none': 'nothing picked',
...
const ko: Record<StringKey, string> = {
  ...
  'welcome.profileChange': '바꾸기',
  'welcome.profileAnswered': '쌓이는 것: {kind}',
  'welcome.profile.none': '아직 안 골랐어요',
