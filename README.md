...
| — | The **arc browser**: 6 category stones fanned above a face in profile, already populated with 47 memories from 22 sources. The same chat box stays docked at the bottom. |
...
above a face in profile standing in its own reflection, with the open category's memories in a reading
