...
- **온보딩 자기소개 (2026-09-24)** — 완료: 첫 줄 "두 번째 '기억'", 질문 전에 '당신을 소개해 줄래요?' 역할 여섯(기획자/PM·창업자/CEO·연구자·개발자·디자이너·마케터, 건너뛰기 가능). 역할별 예시 2개씩 순환, 되묻기 힌트, 되묻기 프롬프트에 역할 전달. 역할은 `mado.ob.role`에 기억됨.
